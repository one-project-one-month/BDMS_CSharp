...
public class UpdateAnnouncementHandler : IRequestHandler<UpdateAnnouncementCommand, Result<AnnouncementRespModel>>
{
    ...
    public async Task<Result<AnnouncementRespModel>> Handle(UpdateAnnouncementCommand request, CancellationToken cancellationToken)
    {
