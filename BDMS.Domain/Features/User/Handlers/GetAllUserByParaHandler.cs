...
{
    public class GetAllUserByParaHandler : IRequestHandler<Commands.GetUserByParameterCommand, Result<UserRespModel>>
    {
        private readonly IUserService _userService;

        public GetAllUserByParaHandler(IUserService userService)
        {
